...
#define SMM_NODE_TYPE_LECTURE               0
#define SMM_NODE_TYPE_RESTAURANT            1
#define SMM_NODE_TYPE_LABORATORY            2
#define SMM_NODE_TYPE_HOME                  3
#define SMM_NODE_TYPE_GOTOLAB               4
#define SMM_NODE_TYPE_FOODCHANCE            5
#define SMM_NODE_TYPE_FESTIVAL              6
